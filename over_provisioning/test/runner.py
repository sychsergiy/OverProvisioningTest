...
class OneOverProvisioningPodTest:
    ...
    def run(self, max_pod_creation_time_in_seconds: float) -> t.Tuple[bool, dict]:
        with self._environment_setuper as env_created_successfully:
            if env_created_successfully:
                with self._pods_cleaner as pods_cleaner:
                    ...
                    self._report_builder.set_nodes_report(initial_amount_of_nodes, amount_of_nodes_after_test)
